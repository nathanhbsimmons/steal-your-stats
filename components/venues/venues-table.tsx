...
export function VenuesTable({ initialVenues, initialTotal }: { initialVenues: VenueStat[]; initialTotal: number }) {
  const [venues] = useState<VenueStat[]>(initialVenues)
      ...
      <div className="page-head">
        ...
        <div className="toolbar">
          <div className="filter-input" style={{ maxWidth: 280 }}>
            ...
            />
            {query && <button type="button" className="clear" aria-label="Clear filter" onClick={() => setQuery('')}>×</button>}
          </div>
        </div>
      </div>
